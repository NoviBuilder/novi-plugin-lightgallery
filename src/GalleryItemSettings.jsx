            ...
            <div className="lg-item-wrap">
                ...
                <div className="input-wrap-group">
                    ...
                    <div className="input-wrap">
                        ...
                        <div className={previewButtonClass} onClick={this.openPreview.bind(this, this.state.src)} data-for="tooltip-global" data-tip={this.messages.editor.item.linkPreviewTooltip}>
